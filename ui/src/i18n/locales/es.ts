...
export const es: TranslationMap = {
  ...
  dreaming: {
    ...
    toggleConfirmation: {
      ...
      enableDetail:
        "El barrido nocturno de Dreaming se ejecutará en todos los espacios de trabajo de agentes configurados, promoviendo los recuerdos a corto plazo a la memoria a largo plazo. Esto se aplica de inmediato.",
      enableConfirm: "Activar Dreaming",
      disableTitle: "Desactivar Dreaming para todos los agentes",
      disableDetail:
        "El barrido nocturno de Dreaming se detendrá para todos los agentes configurados, no solo para este. Los recuerdos ya escritos se conservan; no se promoverá nada nuevo. Esto se aplica de inmediato.",
  ...
  chat: {
    ...
    sessionHeader: {
      ...
      gatewayPicker: {
        ...
        openSettings: "Ajustes de Gateway…",
        connected: "Conectado",
