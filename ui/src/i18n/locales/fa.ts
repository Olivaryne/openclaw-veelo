...
export const fa: TranslationMap = {
  ...
  newSession: {
    ...
    draft: "پیش‌نویس",
    draftDescription: "این رشته را تا زمان انتشار برای خودتان نگه دارید",
  ...
  dreaming: {
    ...
    toggleConfirmation: {
      subtitle: "Dreaming یک تنظیم سراسری است؛ محدود به این عامل نیست.",
      enableTitle: "روشن کردن Dreaming برای همه عامل‌ها",
      enableDetail:
        "پویش شبانه Dreaming در همه فضاهای کاری عامل‌های پیکربندی‌شده اجرا می‌شود و یادآوری‌های کوتاه‌مدت را به حافظه بلندمدت ارتقا می‌دهد. این تغییر بلافاصله اعمال می‌شود.",
      enableConfirm: "روشن کردن Dreaming",
      disableTitle: "خاموش کردن Dreaming برای همه عامل‌ها",
      disableDetail:
        "پویش شبانه Dreaming برای همه عامل‌های پیکربندی‌شده متوقف می‌شود، نه فقط این یکی. حافظه‌هایی که قبلاً نوشته شده‌اند باقی می‌مانند؛ چیز جدیدی ارتقا نمی‌یابد. این تغییر بلافاصله اعمال می‌شود.",
  ...
  chat: {
    ...
    sessionRoute: {
      ...
      additionalMatches: "نتایج جستجو باقی مانده‌اند. از پیشوند شناسه بلندتری استفاده کنید.",
    },
    sessionSharing: {
