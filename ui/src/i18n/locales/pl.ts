...
export const pl: TranslationMap = {
  ...
  dreaming: {
    ...
    toggleConfirmation: {
      subtitle: "Śnienie to ustawienie globalne; nie jest ograniczone do tego agenta.",
      enableTitle: "Włącz śnienie dla wszystkich agentów",
      enableDetail:
        "Nocny cykl śnienia będzie działać we wszystkich skonfigurowanych obszarach roboczych agentów, przenosząc krótkotrwałe wspomnienia do pamięci długotrwałej. Zmiana obowiązuje natychmiast.",
      enableConfirm: "Włącz śnienie",
      disableTitle: "Wyłącz śnienie dla wszystkich agentów",
      disableDetail:
        "Nocny cykl śnienia zatrzyma się dla każdego skonfigurowanego agenta, nie tylko tego. Już zapisane wspomnienia pozostaną; nic nowego nie zostanie przeniesione. Zmiana obowiązuje natychmiast.",
  ...
  chat: {
    ...
    sidebarColumns: {
      ...
      dropOnEmptyLeft: "Przenieś {panel} do pustego lewego paska bocznego",
      dropOnEmptyRight: "Przenieś {panel} do pustego prawego paska bocznego",
