...
export const uk: TranslationMap = {
  ...
  newSession: {
    ...
    draft: "Чернетка",
    draftDescription: "Тримайте цю гілку при собі, доки не опублікуєте її",
  ...
  dreaming: {
    ...
    toggleConfirmation: {
      ...
      enableDetail:
        "Нічний прохід сновидінь виконуватиметься для кожного налаштованого робочого простору агента, переносячи короткочасні спогади в довгострокову пам’ять. Це застосовується негайно.",
      enableConfirm: "Увімкнути сновидіння",
      disableTitle: "Вимкнути сновидіння для всіх агентів",
      disableDetail:
        "Нічний прохід сновидінь зупиниться для кожного налаштованого агента, а не лише для цього. Вже записані спогади залишаються; нічого нового не переноситься. Це застосовується негайно.",
  ...
  chat: {
    ...
    sessionRoute: {
      chooseTitle: "Виберіть сесію",
      multipleMatches: "Кілька сесій відповідають {shortId}.",
      additionalMatches: "Результати пошуку залишаються. Використайте довший префікс id.",
    },
    sessionSharing: {
