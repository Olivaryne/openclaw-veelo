...
export const nl: TranslationMap = {
  ...
  newSession: {
    ...
    draft: "Concept",
    draftDescription: "Houd dit gesprek voor jezelf totdat je het publiceert",
  ...
  dreaming: {
    ...
    toggleConfirmation: {
      subtitle: "Dreaming is een globale instelling; deze is niet beperkt tot deze agent.",
      enableTitle: "Dreaming inschakelen voor alle agents",
      enableDetail:
        "De nachtelijke dreaming-sweep wordt uitgevoerd in elke geconfigureerde agent-workspace en zet kortetermijnherinneringen om in langetermijngeheugen. Dit wordt direct toegepast.",
      enableConfirm: "Dreaming inschakelen",
      disableTitle: "Dreaming uitschakelen voor alle agents",
      disableDetail:
        "De nachtelijke dreaming-sweep stopt voor elke geconfigureerde agent, niet alleen voor deze. Reeds opgeslagen herinneringen blijven behouden; er wordt niets nieuws omgezet. Dit wordt direct toegepast.",
  ...
  chat: {
    ...
    sidebarColumns: {
      ...
      resize: "{panel} vergroten/verkleinen",
    },
    thread: {
