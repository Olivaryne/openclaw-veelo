...
export const id: TranslationMap = {
  ...
  newSession: {
    ...
    draft: "Draf",
    draftDescription: "Simpan utas ini untuk diri Anda sendiri hingga Anda menerbitkannya",
  ...
  dreaming: {
    ...
    toggleConfirmation: {
      ...
      disableDetail:
        "Penyapuan dreaming malam hari akan berhenti untuk setiap agen yang dikonfigurasi, bukan hanya yang ini. Memori yang sudah ditulis tetap ada; tidak ada yang baru yang dipromosikan. Ini berlaku segera.",
  ...
  chat: {
    ...
    sessionRoute: {
      ...
      additionalMatches: "Hasil pencarian masih ada. Gunakan prefiks id yang lebih panjang.",
    },
    sessionSharing: {
      menu: "Berbagi thread",
