...
export const tr: TranslationMap = {
  ...
  dreaming: {
    ...
    toggleConfirmation: {
      subtitle: "Rüya görme genel bir ayardır; bu aracıya özgü değildir.",
      enableTitle: "Tüm Aracılar İçin Rüya Görmeyi Aç",
      enableDetail:
        "Gece rüya görme taraması, yapılandırılmış her aracı çalışma alanında çalışarak kısa süreli hatırlamaları uzun süreli belleğe aktarır. Bu hemen uygulanır.",
      enableConfirm: "Rüya Görmeyi Aç",
      disableTitle: "Tüm Aracılar İçin Rüya Görmeyi Kapat",
      disableDetail:
        "Gece rüya görme taraması yalnızca bu aracı için değil, yapılandırılmış her aracı için durur. Zaten yazılmış anılar kalır; yeni hiçbir şey aktarılmaz. Bu hemen uygulanır.",
  ...
  chat: {
    ...
    sessionRoute: {
      ...
      additionalMatches: "Arama sonuçları kaldı. Daha uzun bir kimlik ön eki kullanın.",
    },
    sessionSharing: {
      menu: "Konu paylaşımı",
    ...
    sidebarColumns: {
      ...
      close: "{panel} kapat",
      drag: "{panel} sürükle",
      dropOnEmptyLeft: "{panel} boş sol kenar çubuğuna taşı",
      dropOnEmptyRight: "{panel} boş sağ kenar çubuğuna taşı",
      resize: "{panel} yeniden boyutlandır",
    },
    thread: {
