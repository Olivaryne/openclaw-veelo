...
export const pt_BR: TranslationMap = {
  ...
  newSession: {
    ...
    draft: "Rascunho",
    draftDescription: "Mantenha este tópico apenas para você até publicá-lo",
  ...
  dreaming: {
    ...
    toggleConfirmation: {
      subtitle: "Dreaming é uma configuração global; não se aplica apenas a este agente.",
      enableTitle: "Ativar Dreaming para Todos os Agentes",
      enableDetail:
        "A varredura noturna de dreaming será executada em todos os workspaces de agentes configurados, promovendo lembranças de curto prazo para a memória de longo prazo. Isso é aplicado imediatamente.",
      enableConfirm: "Ativar Dreaming",
      disableTitle: "Desativar Dreaming para Todos os Agentes",
      disableDetail:
        "A varredura noturna de dreaming será interrompida para todos os agentes configurados, não apenas este. As memórias já gravadas permanecem; nada de novo é promovido. Isso é aplicado imediatamente.",
      disableConfirm: "Desativar Dreaming",
      saving: "Salvando…",
